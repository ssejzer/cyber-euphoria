...
- **Voice Synthesis:** Harmonic sine series tuned to female vocal timbre, rising in pitch and pace with sync level. Win state triggers a rapid climax arc.
...
- **Server Leaderboard:** Top 5 scores stored server-side (`GET/POST /leaderboard`).
- **Milestone Popups:** Flash overlays at 25 / 50 / 75 % sync with haptic feedback.
